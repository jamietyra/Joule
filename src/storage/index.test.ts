...
import { createCallLog, type CallLog, type CallLogRecord } from './index';
...
describe('Storage', () => {
  ...
  it('aggregateSavings computes correct sums and counts', () => {
    ...
    records.forEach(r => storage.appendCallLog(r));

    const savings = storage.aggregateSavings();

    expect(savings.totalCarbonGrams).toBe(0.045 + 0.060 + 0.200 + 0.500);
    expect(savings.totalCostUsd).toBe(0.00002 + 0.00003 + 0.00010 + 0.00025);
